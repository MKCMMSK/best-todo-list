...
module.exports = (helpers) => {
    ...
    request(
      {
        ...
        if (restaurantObj) {
          const restaurant = {
            category_id: 4,
            title: titleSlice(restaurantObj.businesses[0].name),
          ...
          if (restaurantObj.businesses[0].categories[0].title) {
            restaurant.description = restaurantObj.businesses[0].categories[0].title;
          } else {
            restaurant.description = "None provided";
          }

          if (restaurantObj.businesses[0].url) {
            restaurant.url = restaurantObj.businesses[0].url;
          } else {
            restaurant.url = "None provided";
          }

          if (restaurantObj.businesses[0].image_url) {
            restaurant.img = restaurantObj.businesses[0].image_url;
          } else {
            restaurant.img = "None provided";
          }

          if (restaurantObj.businesses[0].location.address1) {
            restaurant.street_address = restaurantObj.businesses[0].location.address1;
          } else {
            restaurant.street_address = "None provided";
          }

          if (restaurantObj.businesses[0].location.city) {
            restaurant.city = restaurantObj.businesses[0].location.city;
          } else {
            restaurant.city = "None provided";
          }

          if (restaurantObj.businesses[0].location.state) {
            restaurant.province_state = restaurantObj.businesses[0].location.state;
          } else {
            restaurant.province_state = "None provided";
          }

          if (restaurantObj.businesses[0].location.country) {
            restaurant.country = restaurantObj.businesses[0].location.country;
          } else {
  ...
  return {getAPIToDo, addToDB, changeCategory, getProduct};
};
