...
module.exports = (helpers) => {
  ...
  function getAPIToDo(search, location, callback) {//fires and stores all api
    let toDoObj = {};
  ...
  function addToDB(search,objObj) { //add into db after finding the probable item, returns an object as well if wrong item
